...
const DepotEspece = () => {
    ...
    const [isDeposantNameManuallyEdited, setIsDeposantNameManuallyEdited] = useState(false);
    ...
    const calculerTotalBilletage = () => {
        if (fetchData2 && fetchData2.CodeMonnaie === 1) {
            return hundred * 100 + fitfty * 50 + twenty * 20 + ten * 10 + five * 5 + oneDollar * 1;
        } else {
            return vightMille * 20000 + dixMille * 10000 + cinqMille * 5000 +
                   milleFranc * 1000 + cinqCentFr * 500 + deuxCentFranc * 200 +
                   centFranc * 100 + cinquanteFanc * 50;
        }
    };

    const totalBilletage = calculerTotalBilletage();
    const montantSaisi = parseMontant(montant);
    const isMontantIncoherent = (totalBilletage !== montantSaisi) && (montantSaisi > 0 || totalBilletage > 0);
    ...
    const getAccountInfo = async (numCompte) => {
        setLoadingData(true);
        const res = await axios.post("/eco/page/depot-espece/get-account/specific", {
            NumCompte: numCompte,
        });
        if (res.data.status === 1) {
    ...
    const saveOperation = async (e) => {
        ...
        try {
            const res = await axios.post("/eco/page/depot-espece/save-deposit", {
                vightMille,
                dixMille,
                cinqMille,
                milleFranc,
    ...
    useEffect(() => {
        const handleKeyDown = (e) => {
            if ((e.ctrlKey && e.key === "Enter") || (e.key === "Enter" && document.activeElement?.id === "Montant")) {
                e.preventDefault();
                ...
                <div className="container-fluid" style={{ marginTop: "10px", padding: "0 15px" }}>
                    ...
                    {isLoadingBar && (
                        <div style={{
                            ...
                            backgroundColor: "rgba(0, 0, 0, 0.7)", zIndex: 1050, backdropFilter: "blur(3px)"
                        }}>
                    ...
                    <div className="row g-3 mb-4">
                        ...
                        <div className="col-md-4">
                            <div className="card border-0 shadow-sm rounded-3 h-100">
                                ...
                                <div className="card-body">
                                    <div className="mb-3">
                                        <div className="input-group">
                                            <input
                                                ...
                                                onChange={(e) => setSearchedAccount(e.target.value)}
                                            />
                                            <button
                                                className="btn"
                                    ...
                                    <hr className="my-3" />
                                    <form>
                                        <table style={{ width: "100%" }} className="table-sm">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style={{ padding: "5px" }}>
                                                        <input type="text" className="form-control" style={{ borderRadius: "8px", backgroundColor: "#f8f9fa" }}
                                                            value={fetchData2 && fetchData2.NomCompte} disabled />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style={{ padding: "5px" }}>
                                                    ...
                                                    <td style={{ padding: "5px" }}>
                                                        <input type="text" className="form-control" style={{ borderRadius: "8px", backgroundColor: "#f8f9fa" }}
                                                            value={fetchData2 && fetchData2.NumCompte} disabled />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style={{ padding: "5px" }}>
                                                    ...
                                                    <td style={{ padding: "5px" }}>
                                                        <input type="text" className="form-control" style={{ borderRadius: "8px", backgroundColor: "#f8f9fa", width: "100px" }}
                                                            value={fetchData2 && fetchData2.CodeAgence} disabled />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                {fetchData && fetchData.map((res, index) => (
                                                    <tr key={index} className="clickable-row" style={{ cursor: "pointer" }}
                                                        onClick={() => getAccountInfo(res.NumCompte)}>
                                                        <td className="py-2 px-3 fw-semibold">{res.NumCompte}</td>
                        ...
                        {fetchSolde && (
                            <div className="col-md-4">
                                <div className="card border-0 shadow-sm rounded-3 h-100" style={{ background: "linear-gradient(135deg, teal 0%, #0a6b6b 100%)" }}>
                    ...
                    <div className="row g-3">
                                        ...
                                        <table style={{ width: "100%" }} className="table-sm">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style={{ padding: "8px" }}>
                                                        <select className="form-control" style={{ borderRadius: "8px" }} disabled
                                                            ...
                                                            <option>{fetchData2?.CodeMonnaie === 1 ? "USD" : "CDF"}</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style={{ padding: "8px" }}>
                                                        <input type="text" className="form-control" style={{ borderRadius: "8px", textTransform: "uppercase" }}
                                                            onChange={(e) => setMotifDepot(e.target.value.toUpperCase())}
                                                            value={motifDepot} placeholder="Motif du dépôt" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style={{ padding: "8px" }}>
                                                        <label style={{ color: "steelblue", fontWeight: "500" }}>Déposant <span className="text-danger">*</span></label>
                                                    </td>
                                                    <td style={{ padding: "8px" }}>
                                                        <input id="DeposantName" required type="text" className="form-control"
                                                            style={{ borderRadius: "8px", textTransform: "uppercase" }}
                                                            onChange={handleDeposantNameChange}
                                                            value={deposantName} placeholder="Nom du déposant" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style={{ padding: "8px" }}>
                                                    ...
                                                    <td style={{ padding: "8px" }}>
                                                        <input type="text" className="form-control" style={{ borderRadius: "8px" }}
                                                            ...
                                                            value={deposantPhone} placeholder="Numéro de téléphone" />
                                                    </td>
                                                </tr>
                                                {commissionConfig === 1 && (
                                                    <tr>
                                                        ...
                                                        <td style={{ padding: "8px" }}>
                                                            <input type="text" className="form-control" style={{ borderRadius: "8px", width: "100px" }}
                                                ...
                                                <tr>
                                                    ...
                                                    <td style={{ padding: "8px" }}>
                                                        <input id="Montant" type="text" className="form-control"
                                                            style={{ borderRadius: "8px", fontWeight: "bold", fontSize: "18px" }}
                                                            onChange={handleMontantChange} value={montant} placeholder="0,00" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div className="col-md-5">
                            <div className="card border-0 shadow-sm rounded-3 h-100">
                                ...
                                <div className="card-body" style={{ maxHeight: "500px", overflowY: "auto" }}>
                                            ...
                                            <table className="table table-bordered table-sm table-ultra-compact">
                                                ...
                                                <tbody>
                                                    {[
                                                        ...
                                                        { value: fitfty, set: setFifty, label: "50", multiplier: 50 },
                                                        ...
                                                        <tr key={idx}>
                                                            ...
                                                            <td>
                                                                <input type="number" className="form-control form-control-sm"
                                                                    ...
                                                                    value={item.value} onChange={(e) => item.set(parseInt(e.target.value) || 0)} />
                                                            </td>
                                                            <td className="fw-bold text-success">{(item.value * item.multiplier).toLocaleString()}</td>
                                                        </tr>
                                                    ))}
                                                    <tr style={{ backgroundColor: "#e6f2f9" }}>
                                                        <th>Total</th>
                                                        <th>{hundred + fitfty + twenty + ten + five + oneDollar}</th>
                                            ...
                                            <table className="table table-bordered table-sm table-ultra-compact">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style={{ backgroundColor: "#e6f2f9" }}>
                                                        <th>Total</th>
                                                        <th>
                                                            {vightMille + dixMille + cinqMille + milleFranc + cinqCentFr + deuxCentFranc + centFranc + cinquanteFanc}
                                                        </th>
                                                        <th className="fw-bold fs-5" style={{ color: "#198764" }}>
                                                            {totalBilletage.toLocaleString()}
                                                        </th>
                                    ...
                                    {isMontantIncoherent && (
                                        <div className="alert alert-warning py-1 mt-2 text-center small">
                                            <i className="fas fa-exclamation-triangle me-1"></i>
                                            Total billetage ({totalBilletage.toLocaleString()}) ≠ montant saisi ({montantSaisi.toLocaleString()})
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="col-md-3 d-flex flex-column">
                            <div className="card border-0 shadow-sm rounded-3 mb-3 ">
                                <div className="card-body">
                                    <button id="validerbtn"
                                        className="btn w-100 py-2 fw-bold"
                                        style={{ background: "linear-gradient(135deg, teal, #0a6b6b)", border: "none", borderRadius: "10px", fontSize: "16px", color: "white" }}
                                        onClick={saveOperation}
                                        disabled={!fetchData2 || !montant || isMontantIncoherent}
                                        title={isMontantIncoherent ? "Le montant ne correspond pas au billetage" : ""}>
                            ...
                            <div className="card border-0 shadow-sm rounded-3 flex-grow-1 d-flex flex-column">
                                <div className="card-header bg-white border-0 pt-3">
                                    <h6 className="fw-bold" style={{ color: "steelblue" }}>
                                            ...
                                            <TableWithPagination
                                                ...
                                                renderRow={(res, idx) => (
                                                    <tr key={idx}>
                                                        ...
                                                        <td>
                                                            <button data-toggle="modal" data-target="#modal-bordereau"
                    ...
                    {/* Modals d'impression */}
                    {selectedData && (getRecuConfig === "Thermique" ? (
