...
const RetraitEspece = () => {
            ...
            <div className="card border-0 shadow-sm rounded-3">
                <div className="card-body p-3" style={{
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            <h5 className="text-white fw-bold mb-0">Retrait D'Espèce</h5>
                            <small className="text-white-50">Opération de retrait d'espèces</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {isLoadingBar && (
            <div style={{
                ...
                <div className="text-center bg-white p-4 rounded-4 shadow-lg">
                    <Bars height="80" width="80" color="#dc3545" ariaLabel="loading" />
                                ...
                                <tr>
                                    ...
                                    <td style={{ padding: "5px" }}>
                                        <input
                                            ...
                                            value={fetchData && fetchData.NomCompte}
                                            disabled
                                        />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style={{ padding: "5px" }}>
                                        <input
                                            ...
                                            style={{ borderRadius: "8px", backgroundColor: "#f8f9fa" }}
                                            disabled
                                            value={fetchData && fetchData.NumCompte}
                                        />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style={{ padding: "5px" }}>
                                        <input
                                            ...
                                            value={fetchData && fetchData.CodeAgence}
                                            disabled
                                        />
                                    </td>
                                </tr>
    ...
    <div className="position-relative my-4">
        ...
        <span className="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted small">
            <i className="fas fa-arrow-down me-1"></i> Informations de retrait
        </span>
    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ padding: "8px" }}>
                                            <select
                                                ...
                                                disabled
                                            >
                                                <option value={fetchData && fetchData.CodeMonnaie}>
                                                    {fetchData && fetchData.CodeMonnaie}
                                                </option>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ padding: "8px" }}>
                                            <input
                                                ...
                                                style={{ borderRadius: "8px", backgroundColor: "#f8f9fa" }}
                                                disabled
                                                value={fetchData && fetchData.Retirant}
                                            />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style={{ padding: "8px" }}>
                                            <input
                                                ...
                                                style={{ borderRadius: "8px", backgroundColor: "#f8f9fa" }}
                                                disabled
                                                value={fetchData && fetchData.NumTel}
                                            />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ padding: "8px" }}>
                                            <input
                                                ...
                                                type="text"
                                                className="form-control"
                                                style={{ borderRadius: "8px", fontWeight: "bold", fontSize: "18px", backgroundColor: "#f8f9fa" }}
                                                disabled
                                                value={fetchData && fetchData.Montant}
                                            />
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table className="table table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr style={{ backgroundColor: "#e6f2f9" }}>
                                        ...
                                        <th className="fw-bold fs-5" style={{ color: "#dc3545" }}>
            ...
            <div className="card border-0 shadow-sm rounded-3 mb-3">
                <div className="card-body">
                    <button
                        ...
                        disabled={
                            (fetchData && fetchData.CodeMonnaie == "USD"
                                ? (hundred * 100 + fitfty * 50 + twenty * 20 + ten * 10 + five * 5 + oneDollar * 1) !== parseInt(fetchData && fetchData.Montant)
                                : (vightMille * 20000 + dixMille * 10000 + cinqMille * 5000 + milleFranc * 1000 +
                                   cinqCentFr * 500 + deuxCentFranc * 200 + centFranc * 100 + cinquanteFanc * 50) !== parseInt(fetchData && fetchData.Montant)
                            ) || !fetchData
                        }
                    >
